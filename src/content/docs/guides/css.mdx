---
title: "CSS 1: Introduction"
description: "Part 1 of the CTL's CSS Introduction."
template: splash
---
...
import css1 from "./src/code/css-1.js";
import css2 from "./src/code/css-2.js";
import css3 from "./src/code/css-3.js";
import css4 from "./src/code/css-4.js";
import css5 from "./src/code/css-5.js";
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{css1.html}</textarea>
    <textarea for="css" open>{css1.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox collapse hidden>
  	<div for="intro"><summary>Solution...</summary></div>
		<textarea for="html">{css1.html}</textarea>
    <textarea for="css" open>{css1.cssSolution}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{css2.html}</textarea>
  </code-sandbox>
</div>
...
| No value | Universal Selector `*`<br/>Combinators `+, >, ~, \|, \|\|, ␣` | 0 |
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{css3.html}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{css4.html}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{css5.html}</textarea>
  </code-sandbox>
</div>
