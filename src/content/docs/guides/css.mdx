...
import {cssSelectors, pseudoClasses, boxModel, marginCollapse, objectFit } from "./src/code/css.js";
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{cssSelectors.html}</textarea>
    <textarea for="css" open>{cssSelectors.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox collapse hidden>
  	<div for="intro"><summary>Solution...</summary></div>
		<textarea for="html">{cssSelectors.html}</textarea>
    <textarea for="css" open>{cssSelectors.cssSolution}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{pseudoClasses.html}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{boxModel.html}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{marginCollapse.html}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{objectFit.html}</textarea>
  </code-sandbox>
</div>
