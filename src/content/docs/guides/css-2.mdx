---
title: "CSS 2: Introduction to CSS Layouts"
description: "Part 2 of the CTL's CSS Introduction."
template: splash
---
...
import { normalFlow, addingFlex, flexFlow, flexSizing, flexAlignment, addingGrid, lineBasedPlacement, gridColumn, gridTemplateAreas } 
from "./src/code/css-2.js";
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html" open>{normalFlow.html}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{addingFlex.html}</textarea>
    <textarea for="css" open>{addingFlex.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{flexFlow.html}</textarea>
    <textarea for="css" open>{flexFlow.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{flexSizing.html}</textarea>
    <textarea for="css" open>{flexSizing.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{flexAlignment.html}</textarea>
    <textarea for="css" open>{flexAlignment.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{addingGrid.html}</textarea>
    <textarea for="css" open>{addingGrid.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{lineBasedPlacement.html}</textarea>
    <textarea for="css" open>{lineBasedPlacement.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{gridColumn.html}</textarea>
    <textarea for="css" open>{gridColumn.css}</textarea>
  </code-sandbox>
</div>
...
<div class="not-content">
  <code-sandbox hidden>
		<textarea for="html">{gridTemplateAreas.html}</textarea>
    <textarea for="css" open>{gridTemplateAreas.css}</textarea>
  </code-sandbox>
</div>
